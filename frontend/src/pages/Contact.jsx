...
export default function Contact() {
  return (
    <>
      <PageHeader eyebrow="Get In Touch" title="Contact & Location" subtitle="Questions, group bookings, or just want to swing by?" />
            ...
            <div className="flex h-full flex-col justify-between rounded-2xl border border-charcoal-lighter bg-charcoal p-8 md:p-10">
              <div className="space-y-7">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="eyebrow mb-1">Telegram</p>
                ...
                <ul className="space-y-2 text-sm">
                  {SHOP.hours.map((h) => (
                    <li key={h.day} className="flex justify-between text-cream-dim">
                      <span>{h.day}</span>
                      <span className={h.time === "Closed" ? "" : "text-cream/90"}>{h.time}</span>
                    </li>
                  ))}
                </ul>
              </div>
